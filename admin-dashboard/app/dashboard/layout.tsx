  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-30 flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2"><img src="/logo-v2.png" alt="Ndlovu Bakery" className="w-7 h-7 object-contain" /><div className="flex items-center gap-2"><img src="/logo-v2.png" alt="Ndlovu Bakery" className="w-7 h-7 object-contain" /><h1 className="font-bold text-gray-800">Ndlovu Bakery</h1></div></div>
        <div className="w-6" />
      </div>
      ...
      <aside className={`fixed lg:static inset-y-0 left-0 w-64 bg-white border-r border-gray-200 flex flex-col z-50 transform transition-transform ${
        ...
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          ...
          <img src="/logo-v2.png" alt="Ndlovu Bakery" className="w-10 h-10 object-contain flex-shrink-0" />
